...
def rand_map(shape, wcs, ps_cmb, ps_lens, lmax=None, dtype=np.float64, seed=None, oversample=2.0, spin=2, output="l", geodesic=True):
	...
	if "p" in output: phi_map = curvedsky.alm2map(phi_alm, obs_pos, oversample=oversample)
