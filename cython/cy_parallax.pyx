...
def update_total(sigma, sigma_max, param_max, hit_tot, r, vy, vx):
	...
	update_total_plain(&sigma_[0], &sigma_max_[0], &param_max_[0], &hit_tot_[0], sigma.shape[0], sigma.shape[1], r, vy, vx)
