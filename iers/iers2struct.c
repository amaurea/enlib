...
int main()
{
	...
	for(i=0; getline(&line, &len, stdin) != -1; i++)
	{
		...
		n=sscanf(fixed, "%d %d %d %5d.00 %c %lf %lf %lf %lf %c %lf %lf %lf %lf %c %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf\n",
		...
		printf("	{%4d, %2d, %2d, %5d, '%c', %9.6f, %9.6f, %9.6lf, %9.6lf, '%c', %10.7lf, %10.7lf, %7.4lf, %7.4lf, '%c', %9.3lf, %9.3lf, %9.3f, %9.3f},\n",
